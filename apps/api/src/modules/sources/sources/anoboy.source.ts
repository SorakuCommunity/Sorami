...
const BASE_URL = 'https://anoboy.ch';

@Injectable()
export class AnoboySource implements AnimeSource {
  readonly name = 'Anoboy';
  readonly type = 'fallback' as const;
  readonly priority = 55;
  private readonly logger = new Logger(AnoboySource.name);
